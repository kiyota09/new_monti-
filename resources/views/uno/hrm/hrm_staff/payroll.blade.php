...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
    ...
    <div id="content-loading-overlay" class="content-loading-overlay">
        ...
        <div class="loading-content">
            ...
            <p>Loading payroll management...</p>
        </div>
    ...
    <div class="lg:col-span-2 space-y-8">
        ...
        <div class="featured-banner content-fade-in stagger-delay-1">
            <div class="p-8">
...
<div class="mt-8">
    <div class="flex justify-between items-center mb-6">
        <h3 class="font-bold text-xl text-gray-900 dark:text-white content-fade-in">Payroll & Finance Team</h3>
